...
// TO DO: Update key color to yellow if letter is in the word but in a different place
...
function checkGuess() {
  if (
    (guessedWord.length == 5 && wordBank.indexOf(guessedWord) !== -1) ||
    (guessedWord.length == 5 && legalWords.indexOf(guessedWord) !== -1)
  ) {
    // Checks that guess is 5 letters long

    console.log(wordBank.indexOf(guessedWord));
